...
+ (PigeonActionCodeInfo *)fromList:(NSArray<id> *)list {
  PigeonActionCodeInfo *pigeonResult = [[PigeonActionCodeInfo alloc] init];
  ActionCodeInfoOperationBox *enumBox = GetNullableObjectAtIndex(list, 0);
  pigeonResult.operation = enumBox.value;
...
- (void)writeValue:(id)value {
  if ([value isKindOfClass:[PigeonMultiFactorSession class]]) {
    ...
    [self writeByte:146];
    [self writeValue:[value toList]];
  } else if ([value isKindOfClass:[ActionCodeInfoOperationBox class]]) {
