...
public class GeneratedAndroidFirebaseCore {
  ...
  public static final class PigeonFirebaseOptions {
    ...
    public boolean equals(Object o) {
      ...
      PigeonFirebaseOptions that = (PigeonFirebaseOptions) o;
    ...
    static @NonNull PigeonFirebaseOptions fromList(@NonNull ArrayList<Object> pigeonVar_list) {
  ...
  public static final class PigeonInitializeResponse {
    ...
    public boolean equals(Object o) {
      if (this == o) { return true; }
      if (o == null || getClass() != o.getClass()) { return false; }
      PigeonInitializeResponse that = (PigeonInitializeResponse) o;
    ...
    static @NonNull PigeonInitializeResponse fromList(@NonNull ArrayList<Object> pigeonVar_list) {
      ...
      pigeonResult.setOptions((PigeonFirebaseOptions) options);
  ...
  public interface FirebaseCoreHostApi {
    ...
    void initializeApp(@NonNull String appName, @NonNull PigeonFirebaseOptions initializeAppRequest, @NonNull Result<PigeonInitializeResponse> result);
