...
class PigeonFirebaseOptions {
 public:
  ...
  explicit PigeonFirebaseOptions(
 ...
 private:
  static PigeonFirebaseOptions FromEncodableList(const flutter::EncodableList& list);
...
class PigeonInitializeResponse {
 public:
  // Constructs an object setting all non-nullable fields.
  explicit PigeonInitializeResponse(
  ...
  ~PigeonInitializeResponse() = default;
  PigeonInitializeResponse(const PigeonInitializeResponse& other);
  PigeonInitializeResponse& operator=(const PigeonInitializeResponse& other);
  PigeonInitializeResponse(PigeonInitializeResponse&& other) = default;
  PigeonInitializeResponse& operator=(PigeonInitializeResponse&& other) noexcept = default;
 ...
 private:
  static PigeonInitializeResponse FromEncodableList(const flutter::EncodableList& list);
  flutter::EncodableList ToEncodableList() const;
  friend class FirebaseCoreHostApi;
  friend class FirebaseAppHostApi;
  friend class PigeonInternalCodecSerializer;
  std::string name_;
  std::unique_ptr<PigeonFirebaseOptions> options_;
...
class FirebaseCoreHostApi {
 public:
  ...
  virtual void OptionsFromResource(std::function<void(ErrorOr<PigeonFirebaseOptions> reply)> result) = 0;
